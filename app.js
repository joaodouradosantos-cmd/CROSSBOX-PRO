...
if (document.getElementById("wodQuadroCard") && typeof renderQuadroWodDia==="function") {
...
const treinos = JSON.parse(localStorage.getItem(STORAGE_TREINO) || "[]") || [];
  const doDia = treinos.filter(t => t.date === dataSelecionada);
