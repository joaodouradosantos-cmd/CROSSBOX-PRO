...
const printHistoryBtn = document.querySelector("#sec-tools #printHistoryBtn") || document.getElementById("printHistoryBtn");
const dailyHistoryBody = document.querySelector("#sec-tools #toolsHistoryBody") || document.getElementById("toolsHistoryBody") || document.getElementById("dailyHistoryBody");
const wodHistoryBody = document.querySelector("#sec-wod #wodHistoryBody") || document.getElementById("wodHistoryBody");
