...
if (treinoDataEl) { renderQuadroWodDia(treinoDataEl.value); }
...
<style>
  ...
  th{background:#f2f2f2;text-align:left;}
    ...
    // Imprimir sem abrir pop-up (evita bloqueadores): usa um iframe invisível
    ...
    // Alguns browsers precisam de um pequeno delay para carregar o conteúdo no iframe
    setTimeout(() => {
      try {
        ...
        console.error(e);
        alert("O browser bloqueou a impressão.");
      } finally {
