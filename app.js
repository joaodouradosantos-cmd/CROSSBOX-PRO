...
if (typeof renderQuadroWodDia === 'function' && typeof treinoDataEl !== 'undefined' && treinoDataEl) {
...
if (wodPhotoBtn && wodPhotoInput) {
  if (wodPhotoBtn) wodPhotoBtn.addEventListener("click", () => {
    wodPhotoInput.value = "";
    wodPhotoInput.click();
  });

  if (wodPhotoInput) wodPhotoInput.addEventListener("change", (e) => {
...
if (printHistoryBtn) {
  if (printHistoryBtn) printHistoryBtn.addEventListener("click", printTreinosPdf);
}
...
if (reservasBtn && reservasSection) {
  if (reservasBtn) reservasBtn.addEventListener("click", () => {
