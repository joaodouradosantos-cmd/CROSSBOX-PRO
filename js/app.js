...
if (treinoData && document.getElementById("wodQuadroCard")) {
...
function updateRmChart() {
  ...
  if (!hasChartJs) {
    ...
    const W = rmChartCanvas.width || rmChartCanvas.clientWidth || 300;
    const H = rmChartCanvas.height || rmChartCanvas.clientHeight || 150;

    // garantir tamanho para alguns browsers
    if (!rmChartCanvas.width) rmChartCanvas.width = W;
    if (!rmChartCanvas.height) rmChartCanvas.height = H;
