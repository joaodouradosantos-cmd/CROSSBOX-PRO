...
const CACHE_NAME = "crossbox-cache-v14-seguranca-chartoffline";
...
const APP_SHELL = [
  ...
  "./manifest.json",
  "./calendario.js",
  // crossbox_logo.png removido do shell (2 MB) — carregado lazy no HTML
  "./imagens/crossbox_logo-192.png",
  "./imagens/crossbox_logo-512.png",
  "./js/chart.umd.min.js",
  // Chart.js via CDN — pré-cacheado para funcionar offline após 1.ª visita com rede
